<template>
    <div>
        ...
        <el-table :data="tableData" v-horizontal-scroll="'always'"
            ...
            <el-table-column prop="eventType" label="事件类型" width="100" header-align="center" align="center">
            </el-table-column>
            <el-table-column prop="eventDate" label="事件发生的时间" width="120" header-align="center" align="center">
            </el-table-column>
            <el-table-column prop="eventLocation" label="事件发生的地点" width="120" header-align="center" align="center">
            </el-table-column>
            <el-table-column prop="eventDescription" label="事件描述" width="120" header-align="center" align="center">
            </el-table-column>
            <el-table-column prop="elderlyId" label="老年人编号" width="100" header-align="center" align="center">
            </el-table-column>
        ...
        <el-dialog title="添加事件" :visible.sync="insertDialogFormVisible" width="400px">
            <el-form :model="form">
                ...
                <el-form-item label="老年人编号" :label-width="formLabelWidth">
                    <el-input v-model="form.elderlyId" autocomplete="off"></el-input>
                </el-form-item>
            </el-form>
